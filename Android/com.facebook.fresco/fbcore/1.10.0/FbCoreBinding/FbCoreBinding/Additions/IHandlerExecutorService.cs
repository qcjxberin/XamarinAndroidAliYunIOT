...
{	
	...
	public partial interface IHandlerExecutorService : global::Java.Util.Concurrent.IScheduledExecutorService
	{
		...
		bool IsHandlerThread
		{
			...
			[Register("isHandlerThread", "()Z", "GetIsHandlerThreadHandler:Com.Facebook.Common.Executors.IHandlerExecutorServiceInvoker, FbCoreBinding")]
			get;
		}
		...
		[Register("quit", "()V", "GetQuitHandler:Com.Facebook.Common.Executors.IHandlerExecutorServiceInvoker, FbCoreBinding")]
		void Quit();

	}

	[global::Android.Runtime.Register("com/facebook/common/executors/HandlerExecutorService", DoNotGenerateAcw = true)]
	internal partial class IHandlerExecutorServiceInvoker : global::Java.Lang.Object, IHandlerExecutorService
	{

		static readonly JniPeerMembers _members = new XAPeerMembers("com/facebook/common/executors/HandlerExecutorService", typeof(IHandlerExecutorServiceInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Com.Facebook.Common.Executors.IHandlerExecutorService __this = global::Java.Lang.Object.GetObject<global::Com.Facebook.Common.Executors.IHandlerExecutorService>(jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return global::Android.Runtime.JavaList.ToLocalJniHandle((System.Collections.IList)__this.ShutdownNow());
		}
#pragma warning restore 0169
		...
		public unsafe global::System.Collections.Generic.IList<global::Java.Lang.IRunnable> ShutdownNow()
		{
			...
			var rawResutl = global::Android.Runtime.JavaList.FromJniHandle(JNIEnv.CallObjectMethod(((global::Java.Lang.Object)this).Handle, id_shutdownNow), JniHandleOwnership.TransferLocalRef);
			return (global::System.Collections.Generic.IList<global::Java.Lang.IRunnable>)rawResutl;
		}
