...
namespace Okhttp3.Internal.Http {
	...
	public sealed partial class Http2xStream : global::Java.Lang.Object, global::Okhttp3.Internal.Http.IHttpStream {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='Http2xStream']/constructor[@name='Http2xStream' and count(parameter)=2 and parameter[1][@type='okhttp3.internal.http.StreamAllocation'] and parameter[2][@type='okhttp3.internal.framed.FramedConnection']]"
		[Register (".ctor", "(Lokhttp3/internal/http/StreamAllocation;Lokhttp3/internal/framed/FramedConnection;)V", "")]
		public unsafe Http2xStream (global::Okhttp3.Internal.Http.StreamAllocation streamAllocation, global::Okhttp3.Internal.Framed.FramedConnection framedConnection)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lokhttp3/internal/http/StreamAllocation;Lokhttp3/internal/framed/FramedConnection;)V";
			...
			try {
				...
				__args [1] = new JniArgumentValue ((framedConnection == null) ? IntPtr.Zero : ((global::Java.Lang.Object) framedConnection).Handle);
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='Http2xStream']/method[@name='setHttpEngine' and count(parameter)=1 and parameter[1][@type='okhttp3.internal.http.HttpEngine']]"
