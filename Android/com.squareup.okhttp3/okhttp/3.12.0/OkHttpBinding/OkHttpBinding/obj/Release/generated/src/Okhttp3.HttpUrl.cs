...
namespace Okhttp3 {
	...
	public sealed partial class HttpUrl : global::Java.Lang.Object {
		...
		public sealed partial class Builder : global::Java.Lang.Object {
			...
			{
				const string __id = "addEncodedPathSegments.(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;";
				IntPtr native_encodedPathSegments = JNIEnv.NewString (encodedPathSegments);
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (native_encodedPathSegments);
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
					return global::Java.Lang.Object.GetObject<global::Okhttp3.HttpUrl.Builder> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
			...
			{
				const string __id = "addPathSegments.(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;";
				IntPtr native_pathSegments = JNIEnv.NewString (pathSegments);
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (native_pathSegments);
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
					return global::Java.Lang.Object.GetObject<global::Okhttp3.HttpUrl.Builder> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
		...
		{
			const string __id = "get.(Ljava/lang/String;)Lokhttp3/HttpUrl;";
		...
		{
			const string __id = "redact.()Ljava/lang/String;";
			try {
				var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
				return JNIEnv.GetString (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
		...
		{
			const string __id = "topPrivateDomain.()Ljava/lang/String;";
			try {
				var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
				return JNIEnv.GetString (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
