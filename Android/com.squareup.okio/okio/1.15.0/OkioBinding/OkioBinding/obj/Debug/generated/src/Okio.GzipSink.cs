...
namespace Okio {
	...
	public sealed partial class GzipSink : global::Java.Lang.Object, global::Okio.ISink {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("okio/GzipSink", typeof (GzipSink));
		...
		public unsafe GzipSink (global::Okio.ISink sink)
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='GzipSink']/method[@name='deflater' and count(parameter)=0]"
		[Register ("deflater", "()Ljava/util/zip/Deflater;", "")]
		public unsafe global::Java.Util.Zip.Deflater Deflater ()
		{
			const string __id = "deflater.()Ljava/util/zip/Deflater;";
			try {
				var __rm = _members.InstanceMethods.InvokeNonvirtualObjectMethod (__id, this, null);
				return global::Java.Lang.Object.GetObject<global::Java.Util.Zip.Deflater> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
