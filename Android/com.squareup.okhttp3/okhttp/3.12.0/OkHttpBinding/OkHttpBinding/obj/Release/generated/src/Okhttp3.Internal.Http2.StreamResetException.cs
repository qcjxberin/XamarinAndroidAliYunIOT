...
namespace Okhttp3.Internal.Http2 {
	...
	public sealed partial class StreamResetException : global::Java.IO.IOException {
		...
		public global::Okhttp3.Internal.Http2.ErrorCode ErrorCode {
			get {
				const string __id = "errorCode.Lokhttp3/internal/http2/ErrorCode;";
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/http2/StreamResetException", typeof (StreamResetException));
		...
		{
			const string __id = "(Lokhttp3/internal/http2/ErrorCode;)V";
