...
#pragma warning restore 0169
			...
			static Delegate cb_socket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_;
#pragma warning disable 0169
			static Delegate GetSocket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_Handler ()
			{
				if (cb_socket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_ == null)
					cb_socket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_Socket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_);
				return cb_socket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_;
			}

			static IntPtr n_Socket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_ (IntPtr jnienv, IntPtr native__this, IntPtr native_socket, IntPtr native_hostname, IntPtr native_source, IntPtr native_sink)
			{
				global::Okhttp3.Internal.Http2.Http2Connection.Builder __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.Http2Connection.Builder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Java.Net.Socket socket = global::Java.Lang.Object.GetObject<global::Java.Net.Socket> (native_socket, JniHandleOwnership.DoNotTransfer);
				string hostname = JNIEnv.GetString (native_hostname, JniHandleOwnership.DoNotTransfer);
				global::Okio.IBufferedSource source = (global::Okio.IBufferedSource)global::Java.Lang.Object.GetObject<global::Okio.IBufferedSource> (native_source, JniHandleOwnership.DoNotTransfer);
				...
				IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.Socket (socket, hostname, source, sink));
				return __ret;
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection.Builder']/method[@name='socket' and count(parameter)=4 and parameter[1][@type='java.net.Socket'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='okio.BufferedSource'] and parameter[4][@type='okio.BufferedSink']]"
			[Register ("socket", "(Ljava/net/Socket;Ljava/lang/String;Lokio/BufferedSource;Lokio/BufferedSink;)Lokhttp3/internal/http2/Http2Connection$Builder;", "GetSocket_Ljava_net_Socket_Ljava_lang_String_Lokio_BufferedSource_Lokio_BufferedSink_Handler")]
			public virtual unsafe global::Okhttp3.Internal.Http2.Http2Connection.Builder Socket (global::Java.Net.Socket socket, string hostname, global::Okio.IBufferedSource source, global::Okio.IBufferedSink sink)
			{
				const string __id = "socket.(Ljava/net/Socket;Ljava/lang/String;Lokio/BufferedSource;Lokio/BufferedSink;)Lokhttp3/internal/http2/Http2Connection$Builder;";
...
#pragma warning disable 0169
			...
			static void n_AlternateService_ILjava_lang_String_Lokio_ByteString_Ljava_lang_String_IJ (IntPtr jnienv, IntPtr native__this, int streamId, IntPtr native_origin, IntPtr native_protocol, IntPtr native_host, int port, long maxAge)
			{
				global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				string origin = JNIEnv.GetString (native_origin, JniHandleOwnership.DoNotTransfer);
				global::Okio.ByteString protocol = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (native_protocol, JniHandleOwnership.DoNotTransfer);
				string host = JNIEnv.GetString (native_host, JniHandleOwnership.DoNotTransfer);
				__this.AlternateService (streamId, origin, protocol, host, port, maxAge);
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection.ReaderRunnable']/method[@name='alternateService' and count(parameter)=6 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='okio.ByteString'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='int'] and parameter[6][@type='long']]"
			[Register ("alternateService", "(ILjava/lang/String;Lokio/ByteString;Ljava/lang/String;IJ)V", "GetAlternateService_ILjava_lang_String_Lokio_ByteString_Ljava_lang_String_IJHandler")]
			public virtual unsafe void AlternateService (int streamId, string origin, global::Okio.ByteString protocol, string host, int port, long maxAge)
			{
				const string __id = "alternateService.(ILjava/lang/String;Lokio/ByteString;Ljava/lang/String;IJ)V";
				IntPtr native_origin = JNIEnv.NewString (origin);
				IntPtr native_host = JNIEnv.NewString (host);
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [6];
					__args [0] = new JniArgumentValue (streamId);
					__args [1] = new JniArgumentValue (native_origin);
					__args [2] = new JniArgumentValue ((protocol == null) ? IntPtr.Zero : ((global::Java.Lang.Object) protocol).Handle);
					__args [3] = new JniArgumentValue (native_host);
					__args [4] = new JniArgumentValue (port);
					__args [5] = new JniArgumentValue (maxAge);
					_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
				} finally {
...
#pragma warning disable 0169
			...
			static void n_Data_ZILokio_BufferedSource_I (IntPtr jnienv, IntPtr native__this, bool inFinished, int streamId, IntPtr native_source, int length)
			{
				global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Okio.IBufferedSource source = (global::Okio.IBufferedSource)global::Java.Lang.Object.GetObject<global::Okio.IBufferedSource> (native_source, JniHandleOwnership.DoNotTransfer);
				__this.Data (inFinished, streamId, source, length);
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection.ReaderRunnable']/method[@name='data' and count(parameter)=4 and parameter[1][@type='boolean'] and parameter[2][@type='int'] and parameter[3][@type='okio.BufferedSource'] and parameter[4][@type='int']]"
			[Register ("data", "(ZILokio/BufferedSource;I)V", "GetData_ZILokio_BufferedSource_IHandler")]
			public virtual unsafe void Data (bool inFinished, int streamId, global::Okio.IBufferedSource source, int length)
			{
				const string __id = "data.(ZILokio/BufferedSource;I)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [4];
...
#pragma warning disable 0169
			...
			static void n_GoAway_ILokhttp3_internal_http2_ErrorCode_Lokio_ByteString_ (IntPtr jnienv, IntPtr native__this, int lastGoodStreamId, IntPtr native_errorCode, IntPtr native_debugData)
			{
				global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				...
				global::Okio.ByteString debugData = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (native_debugData, JniHandleOwnership.DoNotTransfer);
				__this.GoAway (lastGoodStreamId, errorCode, debugData);
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection.ReaderRunnable']/method[@name='goAway' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='okhttp3.internal.http2.ErrorCode'] and parameter[3][@type='okio.ByteString']]"
			[Register ("goAway", "(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V", "GetGoAway_ILokhttp3_internal_http2_ErrorCode_Lokio_ByteString_Handler")]
			public virtual unsafe void GoAway (int lastGoodStreamId, global::Okhttp3.Internal.Http2.ErrorCode errorCode, global::Okio.ByteString debugData)
			{
				const string __id = "goAway.(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V";
				try {
					...
					__args [2] = new JniArgumentValue ((debugData == null) ? IntPtr.Zero : ((global::Java.Lang.Object) debugData).Handle);
					_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
				} finally {
				}
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection']/method[@name='writeData' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='boolean'] and parameter[3][@type='okio.Buffer'] and parameter[4][@type='long']]"
		[Register ("writeData", "(IZLokio/Buffer;J)V", "")]
		public unsafe void WriteData (int streamId, bool outFinished, global::Okio.Buffer buffer, long byteCount)
		{
			const string __id = "writeData.(IZLokio/Buffer;J)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [4];
				__args [0] = new JniArgumentValue (streamId);
				__args [1] = new JniArgumentValue (outFinished);
