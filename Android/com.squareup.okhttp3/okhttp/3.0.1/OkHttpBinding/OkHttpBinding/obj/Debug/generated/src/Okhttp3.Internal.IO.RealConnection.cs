...
namespace Okhttp3.Internal.IO {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']"
	[global::Android.Runtime.Register ("okhttp3/internal/io/RealConnection", DoNotGenerateAcw=true)]
	public sealed partial class RealConnection : global::Java.Lang.Object, global::Okhttp3.IConnection {



		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/field[@name='allocations']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/field[@name='framedConnection']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/field[@name='idleAtNanos']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/field[@name='noNewStreams']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/field[@name='successCount']"
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/io/RealConnection", typeof (RealConnection));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/constructor[@name='RealConnection' and count(parameter)=1 and parameter[1][@type='okhttp3.Route']]"
		...
		public unsafe bool IsMultiplexed {
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='isMultiplexed' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='allocationLimit' and count(parameter)=0]"
		[Register ("allocationLimit", "()I", "")]
		public unsafe int AllocationLimit ()
		{
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='cancel' and count(parameter)=0]"
		[Register ("cancel", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='handshake' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='isHealthy' and count(parameter)=1 and parameter[1][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='protocol' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='route' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.io']/class[@name='RealConnection']/method[@name='socket' and count(parameter)=0]"
