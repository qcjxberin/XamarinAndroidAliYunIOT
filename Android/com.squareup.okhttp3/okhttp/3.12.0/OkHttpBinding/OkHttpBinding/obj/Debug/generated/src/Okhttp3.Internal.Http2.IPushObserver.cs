...
namespace Okhttp3.Internal.Http2 {
	...
	public partial interface IPushObserver : IJavaObject, IJavaPeerable {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/interface[@name='PushObserver']/method[@name='onData' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='okio.BufferedSource'] and parameter[3][@type='int'] and parameter[4][@type='boolean']]"
		[Register ("onData", "(ILokio/BufferedSource;IZ)Z", "GetOnData_ILokio_BufferedSource_IZHandler:Okhttp3.Internal.Http2.IPushObserverInvoker, OkHttpBinding")]
		bool OnData (int p0, global::Okio.IBufferedSource p1, int p2, bool p3);
	...
	internal partial class IPushObserverInvoker : global::Java.Lang.Object, IPushObserver {
		...
		static Delegate cb_onData_ILokio_BufferedSource_IZ;
#pragma warning disable 0169
		static Delegate GetOnData_ILokio_BufferedSource_IZHandler ()
		{
			if (cb_onData_ILokio_BufferedSource_IZ == null)
				cb_onData_ILokio_BufferedSource_IZ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int, IntPtr, int, bool, bool>) n_OnData_ILokio_BufferedSource_IZ);
			return cb_onData_ILokio_BufferedSource_IZ;
		}
...
#pragma warning restore 0169
		...
		IntPtr id_onData_ILokio_BufferedSource_IZ;
