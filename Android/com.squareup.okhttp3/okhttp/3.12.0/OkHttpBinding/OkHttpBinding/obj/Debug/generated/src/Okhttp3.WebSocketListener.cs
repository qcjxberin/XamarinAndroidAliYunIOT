...
#pragma warning restore 0169
		...
		static Delegate cb_onMessage_Lokhttp3_WebSocket_Lokio_ByteString_;
#pragma warning disable 0169
		static Delegate GetOnMessage_Lokhttp3_WebSocket_Lokio_ByteString_Handler ()
		{
			if (cb_onMessage_Lokhttp3_WebSocket_Lokio_ByteString_ == null)
				cb_onMessage_Lokhttp3_WebSocket_Lokio_ByteString_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, IntPtr>) n_OnMessage_Lokhttp3_WebSocket_Lokio_ByteString_);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='WebSocketListener']/method[@name='onMessage' and count(parameter)=2 and parameter[1][@type='okhttp3.WebSocket'] and parameter[2][@type='okio.ByteString']]"
		[Register ("onMessage", "(Lokhttp3/WebSocket;Lokio/ByteString;)V", "GetOnMessage_Lokhttp3_WebSocket_Lokio_ByteString_Handler")]
		public virtual unsafe void OnMessage (global::Okhttp3.IWebSocket webSocket, global::Okio.ByteString bytes)
		{
			const string __id = "onMessage.(Lokhttp3/WebSocket;Lokio/ByteString;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue ((webSocket == null) ? IntPtr.Zero : ((global::Java.Lang.Object) webSocket).Handle);
