...
#pragma warning restore 0169
		...
		[Register ("callEngineGetStreamAllocation", "(Lokhttp3/Call;)Lokhttp3/internal/connection/StreamAllocation;", "GetCallEngineGetStreamAllocation_Lokhttp3_Call_Handler")]
		public abstract global::Okhttp3.Internal.Connection.StreamAllocation CallEngineGetStreamAllocation (global::Okhttp3.ICall p0);
...
#pragma warning restore 0169
		...
		static Delegate cb_get_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_;
#pragma warning disable 0169
		static Delegate GetGet_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_Handler ()
		{
			if (cb_get_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_ == null)
				cb_get_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_Get_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_);
			return cb_get_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_;
		}

		static IntPtr n_Get_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1, IntPtr native_p2)
		{
			global::Okhttp3.Internal.Internal __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Internal> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okhttp3.ConnectionPool p0 = global::Java.Lang.Object.GetObject<global::Okhttp3.ConnectionPool> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Internal']/method[@name='get' and count(parameter)=3 and parameter[1][@type='okhttp3.ConnectionPool'] and parameter[2][@type='okhttp3.Address'] and parameter[3][@type='okhttp3.internal.connection.StreamAllocation']]"
		[Register ("get", "(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/connection/RealConnection;", "GetGet_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_Handler")]
		public abstract global::Okhttp3.Internal.Connection.RealConnection Get (global::Okhttp3.ConnectionPool p0, global::Okhttp3.Address p1, global::Okhttp3.Internal.Connection.StreamAllocation p2);
...
#pragma warning restore 0169
		...
		static Delegate cb_setCallWebSocket_Lokhttp3_Call_;
#pragma warning disable 0169
		static Delegate GetSetCallWebSocket_Lokhttp3_Call_Handler ()
		{
			if (cb_setCallWebSocket_Lokhttp3_Call_ == null)
				cb_setCallWebSocket_Lokhttp3_Call_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetCallWebSocket_Lokhttp3_Call_);
			return cb_setCallWebSocket_Lokhttp3_Call_;
		}

		static void n_SetCallWebSocket_Lokhttp3_Call_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Okhttp3.Internal.Internal __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Internal> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okhttp3.ICall p0 = (global::Okhttp3.ICall)global::Java.Lang.Object.GetObject<global::Okhttp3.ICall> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.SetCallWebSocket (p0);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Internal']/method[@name='setCallWebSocket' and count(parameter)=1 and parameter[1][@type='okhttp3.Call']]"
		[Register ("setCallWebSocket", "(Lokhttp3/Call;)V", "GetSetCallWebSocket_Lokhttp3_Call_Handler")]
		public abstract void SetCallWebSocket (global::Okhttp3.ICall p0);
	...
	internal partial class InternalInvoker : Internal {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Internal']/method[@name='callEngineGetStreamAllocation' and count(parameter)=1 and parameter[1][@type='okhttp3.Call']]"
		[Register ("callEngineGetStreamAllocation", "(Lokhttp3/Call;)Lokhttp3/internal/connection/StreamAllocation;", "GetCallEngineGetStreamAllocation_Lokhttp3_Call_Handler")]
		public override unsafe global::Okhttp3.Internal.Connection.StreamAllocation CallEngineGetStreamAllocation (global::Okhttp3.ICall p0)
		{
			const string __id = "callEngineGetStreamAllocation.(Lokhttp3/Call;)Lokhttp3/internal/connection/StreamAllocation;";
			try {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Internal']/method[@name='get' and count(parameter)=3 and parameter[1][@type='okhttp3.ConnectionPool'] and parameter[2][@type='okhttp3.Address'] and parameter[3][@type='okhttp3.internal.connection.StreamAllocation']]"
		[Register ("get", "(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/connection/RealConnection;", "GetGet_Lokhttp3_ConnectionPool_Lokhttp3_Address_Lokhttp3_internal_connection_StreamAllocation_Handler")]
		public override unsafe global::Okhttp3.Internal.Connection.RealConnection Get (global::Okhttp3.ConnectionPool p0, global::Okhttp3.Address p1, global::Okhttp3.Internal.Connection.StreamAllocation p2)
		{
			const string __id = "get.(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/connection/RealConnection;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [3];
				__args [0] = new JniArgumentValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
				__args [1] = new JniArgumentValue ((p1 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p1).Handle);
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Internal']/method[@name='setCallWebSocket' and count(parameter)=1 and parameter[1][@type='okhttp3.Call']]"
		[Register ("setCallWebSocket", "(Lokhttp3/Call;)V", "GetSetCallWebSocket_Lokhttp3_Call_Handler")]
		public override unsafe void SetCallWebSocket (global::Okhttp3.ICall p0)
		{
			const string __id = "setCallWebSocket.(Lokhttp3/Call;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
				_members.InstanceMethods.InvokeAbstractVoidMethod (__id, this, __args);
