...
namespace Okhttp3.Internal.Http2 {
	...
	public sealed partial class Header : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='PSEUDO_PREFIX']"
		[Register ("PSEUDO_PREFIX")]
		public static global::Okio.ByteString PseudoPrefix {
			get {
				const string __id = "PSEUDO_PREFIX.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='RESPONSE_STATUS']"
		[Register ("RESPONSE_STATUS")]
		public static global::Okio.ByteString ResponseStatus {
			get {
				const string __id = "RESPONSE_STATUS.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='TARGET_AUTHORITY']"
		[Register ("TARGET_AUTHORITY")]
		public static global::Okio.ByteString TargetAuthority {
			get {
				const string __id = "TARGET_AUTHORITY.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='TARGET_METHOD']"
		[Register ("TARGET_METHOD")]
		public static global::Okio.ByteString TargetMethod {
			get {
				const string __id = "TARGET_METHOD.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='TARGET_PATH']"
		[Register ("TARGET_PATH")]
		public static global::Okio.ByteString TargetPath {
			get {
				const string __id = "TARGET_PATH.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='TARGET_SCHEME']"
		[Register ("TARGET_SCHEME")]
		public static global::Okio.ByteString TargetScheme {
			get {
				const string __id = "TARGET_SCHEME.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='name']"
		[Register ("name")]
		public global::Okio.ByteString Name {
			get {
				const string __id = "name.Lokio/ByteString;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/field[@name='value']"
		[Register ("value")]
		public global::Okio.ByteString Value {
			get {
				const string __id = "value.Lokio/ByteString;";
...
#pragma warning restore 0649
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/constructor[@name='Header' and count(parameter)=2 and parameter[1][@type='okio.ByteString'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Lokio/ByteString;Ljava/lang/String;)V", "")]
		public unsafe Header (global::Okio.ByteString name, string value)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lokio/ByteString;Ljava/lang/String;)V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Header']/constructor[@name='Header' and count(parameter)=2 and parameter[1][@type='okio.ByteString'] and parameter[2][@type='okio.ByteString']]"
		[Register (".ctor", "(Lokio/ByteString;Lokio/ByteString;)V", "")]
		public unsafe Header (global::Okio.ByteString name, global::Okio.ByteString value)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lokio/ByteString;Lokio/ByteString;)V";
