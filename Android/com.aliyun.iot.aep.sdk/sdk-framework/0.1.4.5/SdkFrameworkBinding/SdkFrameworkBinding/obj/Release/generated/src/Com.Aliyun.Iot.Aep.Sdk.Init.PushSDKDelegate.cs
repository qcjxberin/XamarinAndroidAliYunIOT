...
namespace Com.Aliyun.Iot.Aep.Sdk.Init {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.init']/class[@name='PushSDKDelegate']"
	[global::Android.Runtime.Register ("com/aliyun/iot/aep/sdk/init/PushSDKDelegate", DoNotGenerateAcw=true)]
	public partial class PushSDKDelegate : global::Com.Aliyun.Iot.Aep.Sdk.Framework.Sdk.SimpleSDKDelegateImp {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/aliyun/iot/aep/sdk/init/PushSDKDelegate", typeof (PushSDKDelegate));
		...
		protected PushSDKDelegate (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.init']/class[@name='PushSDKDelegate']/constructor[@name='PushSDKDelegate' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushSDKDelegate ()
...
#pragma warning disable 0169
		...
		{
			global::Com.Aliyun.Iot.Aep.Sdk.Init.PushSDKDelegate __this = global::Java.Lang.Object.GetObject<global::Com.Aliyun.Iot.Aep.Sdk.Init.PushSDKDelegate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
