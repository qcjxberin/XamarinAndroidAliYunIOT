...
namespace Okhttp3.Internal.Connection {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='okhttp3.internal.connection']/class[@name='ConnectionSpecSelector']"
	[global::Android.Runtime.Register ("okhttp3/internal/connection/ConnectionSpecSelector", DoNotGenerateAcw=true)]
	public sealed partial class ConnectionSpecSelector : global::Java.Lang.Object {

		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/connection/ConnectionSpecSelector", typeof (ConnectionSpecSelector));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal.connection']/class[@name='ConnectionSpecSelector']/constructor[@name='ConnectionSpecSelector' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;okhttp3.ConnectionSpec&gt;']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.connection']/class[@name='ConnectionSpecSelector']/method[@name='configureSecureSocket' and count(parameter)=1 and parameter[1][@type='javax.net.ssl.SSLSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.connection']/class[@name='ConnectionSpecSelector']/method[@name='connectionFailed' and count(parameter)=1 and parameter[1][@type='java.io.IOException']]"
