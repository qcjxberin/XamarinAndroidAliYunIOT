...
namespace Okhttp3.Internal {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']"
	[global::Android.Runtime.Register ("okhttp3/internal/Platform", DoNotGenerateAcw=true)]
	public partial class Platform : global::Java.Lang.Object {

		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/Platform", typeof (Platform));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/constructor[@name='Platform' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
...
#pragma warning restore 0169
		...
		public virtual unsafe string Prefix {
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='getPrefix' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='afterHandshake' and count(parameter)=1 and parameter[1][@type='javax.net.ssl.SSLSocket']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='configureTlsExtensions' and count(parameter)=3 and parameter[1][@type='javax.net.ssl.SSLSocket'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.util.List&lt;okhttp3.Protocol&gt;']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='connectSocket' and count(parameter)=3 and parameter[1][@type='java.net.Socket'] and parameter[2][@type='java.net.InetSocketAddress'] and parameter[3][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='get' and count(parameter)=0]"
		[Register ("get", "()Lokhttp3/internal/Platform;", "")]
		public static unsafe global::Okhttp3.Internal.Platform Get ()
		{
			const string __id = "get.()Lokhttp3/internal/Platform;";
			try {
				var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Platform> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='getSelectedProtocol' and count(parameter)=1 and parameter[1][@type='javax.net.ssl.SSLSocket']]"
...
#pragma warning disable 0169
		...
		static void n_Log_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_message)
		{
			global::Okhttp3.Internal.Platform __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Platform> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='log' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("log", "(Ljava/lang/String;)V", "GetLog_Ljava_lang_String_Handler")]
		public virtual unsafe void Log (string message)
		{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='logW' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("logW", "(Ljava/lang/String;)V", "GetLogW_Ljava_lang_String_Handler")]
		public virtual unsafe void LogW (string warning)
		{
			const string __id = "logW.(Ljava/lang/String;)V";
			IntPtr native_warning = JNIEnv.NewString (warning);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (native_warning);
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_warning);
			}
		}
...
#pragma warning disable 0169
		...
		static void n_TagSocket_Ljava_net_Socket_ (IntPtr jnienv, IntPtr native__this, IntPtr native_socket)
		{
			global::Okhttp3.Internal.Platform __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Platform> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.Net.Socket socket = global::Java.Lang.Object.GetObject<global::Java.Net.Socket> (native_socket, JniHandleOwnership.DoNotTransfer);
			__this.TagSocket (socket);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='tagSocket' and count(parameter)=1 and parameter[1][@type='java.net.Socket']]"
		[Register ("tagSocket", "(Ljava/net/Socket;)V", "GetTagSocket_Ljava_net_Socket_Handler")]
		public virtual unsafe void TagSocket (global::Java.Net.Socket socket)
		{
			const string __id = "tagSocket.(Ljava/net/Socket;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((socket == null) ? IntPtr.Zero : ((global::Java.Lang.Object) socket).Handle);
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Platform']/method[@name='untagSocket' and count(parameter)=1 and parameter[1][@type='java.net.Socket']]"
