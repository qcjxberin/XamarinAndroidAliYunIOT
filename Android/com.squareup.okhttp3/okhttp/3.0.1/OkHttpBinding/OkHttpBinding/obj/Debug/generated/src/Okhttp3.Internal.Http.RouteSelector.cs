...
namespace Okhttp3.Internal.Http {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='RouteSelector']"
	[global::Android.Runtime.Register ("okhttp3/internal/http/RouteSelector", DoNotGenerateAcw=true)]
	public sealed partial class RouteSelector : global::Java.Lang.Object {

		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/http/RouteSelector", typeof (RouteSelector));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='RouteSelector']/constructor[@name='RouteSelector' and count(parameter)=2 and parameter[1][@type='okhttp3.Address'] and parameter[2][@type='okhttp3.internal.RouteDatabase']]"
		[Register (".ctor", "(Lokhttp3/Address;Lokhttp3/internal/RouteDatabase;)V", "")]
		...
		public unsafe bool HasNext {
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='RouteSelector']/method[@name='hasNext' and count(parameter)=0]"
			[Register ("hasNext", "()Z", "")]
			get {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='RouteSelector']/method[@name='connectFailed' and count(parameter)=2 and parameter[1][@type='okhttp3.Route'] and parameter[2][@type='java.io.IOException']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http']/class[@name='RouteSelector']/method[@name='next' and count(parameter)=0]"
