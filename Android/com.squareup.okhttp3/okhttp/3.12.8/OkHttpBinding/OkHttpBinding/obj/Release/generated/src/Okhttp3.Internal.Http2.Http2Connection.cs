...
#pragma warning restore 0169
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection.IntervalPingRunnable']"
		[global::Android.Runtime.Register ("okhttp3/internal/http2/Http2Connection$IntervalPingRunnable", DoNotGenerateAcw=true)]
		public sealed partial class IntervalPingRunnable : global::Okhttp3.Internal.NamedRunnable {

			static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/http2/Http2Connection$IntervalPingRunnable", typeof (IntervalPingRunnable));
			internal static new IntPtr class_ref {
				get {
					return _members.JniPeerType.PeerReference.Handle;
				}
			...
			internal IntervalPingRunnable (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
...
#pragma warning disable 0169
			...
			static void n_Settings_ZLokhttp3_internal_http2_Settings_ (IntPtr jnienv, IntPtr native__this, bool clearPrevious, IntPtr native_settings)
			{
				global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.Http2Connection.ReaderRunnable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Okhttp3.Internal.Http2.Settings settings = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Http2.Settings> (native_settings, JniHandleOwnership.DoNotTransfer);
				__this.Settings (clearPrevious, settings);
			}
#pragma warning restore 0169
			...
			public virtual unsafe void Settings (bool clearPrevious, global::Okhttp3.Internal.Http2.Settings settings)
			{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection']/method[@name='isHealthy' and count(parameter)=1 and parameter[1][@type='long']]"
		[Register ("isHealthy", "(J)Z", "")]
		public unsafe bool IsHealthy (long nowNs)
		{
			const string __id = "isHealthy.(J)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (nowNs);
