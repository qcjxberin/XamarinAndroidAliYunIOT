...
namespace Com.Google.Gson.Annotations {
	...
	public partial interface ISerializedName : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("alternate", "()[Ljava/lang/String;", "GetAlternateHandler:Com.Google.Gson.Annotations.ISerializedNameInvoker, GsonBinding")]
		string[] Alternate ();
		...
		[Register ("value", "()Ljava/lang/String;", "GetValueHandler:Com.Google.Gson.Annotations.ISerializedNameInvoker, GsonBinding")]
		string Value ();

	}

	[global::Android.Runtime.Register ("com/google/gson/annotations/SerializedName", DoNotGenerateAcw=true)]
	internal partial class ISerializedNameInvoker : global::Java.Lang.Object, ISerializedName {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/gson/annotations/SerializedName", typeof (ISerializedNameInvoker));
