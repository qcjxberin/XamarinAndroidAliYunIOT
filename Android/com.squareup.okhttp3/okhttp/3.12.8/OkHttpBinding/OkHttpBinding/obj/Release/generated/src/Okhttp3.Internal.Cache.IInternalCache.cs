...
namespace Okhttp3.Internal.Cache {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']"
	[Register ("okhttp3/internal/cache/InternalCache", "", "Okhttp3.Internal.Cache.IInternalCacheInvoker")]
	public partial interface IInternalCache : IJavaObject, IJavaPeerable {

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']/method[@name='get' and count(parameter)=1 and parameter[1][@type='okhttp3.Request']]"
		[Register ("get", "(Lokhttp3/Request;)Lokhttp3/Response;", "GetGet_Lokhttp3_Request_Handler:Okhttp3.Internal.Cache.IInternalCacheInvoker, OkHttpBinding")]
		global::Okhttp3.Response Get (global::Okhttp3.Request p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']/method[@name='put' and count(parameter)=1 and parameter[1][@type='okhttp3.Response']]"
		[Register ("put", "(Lokhttp3/Response;)Lokhttp3/internal/cache/CacheRequest;", "GetPut_Lokhttp3_Response_Handler:Okhttp3.Internal.Cache.IInternalCacheInvoker, OkHttpBinding")]
		global::Okhttp3.Internal.Cache.ICacheRequest Put (global::Okhttp3.Response p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']/method[@name='remove' and count(parameter)=1 and parameter[1][@type='okhttp3.Request']]"
		[Register ("remove", "(Lokhttp3/Request;)V", "GetRemove_Lokhttp3_Request_Handler:Okhttp3.Internal.Cache.IInternalCacheInvoker, OkHttpBinding")]
		void Remove (global::Okhttp3.Request p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']/method[@name='trackConditionalCacheHit' and count(parameter)=0]"
		[Register ("trackConditionalCacheHit", "()V", "GetTrackConditionalCacheHitHandler:Okhttp3.Internal.Cache.IInternalCacheInvoker, OkHttpBinding")]
		void TrackConditionalCacheHit ();

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']/method[@name='trackResponse' and count(parameter)=1 and parameter[1][@type='okhttp3.internal.cache.CacheStrategy']]"
		[Register ("trackResponse", "(Lokhttp3/internal/cache/CacheStrategy;)V", "GetTrackResponse_Lokhttp3_internal_cache_CacheStrategy_Handler:Okhttp3.Internal.Cache.IInternalCacheInvoker, OkHttpBinding")]
		void TrackResponse (global::Okhttp3.Internal.Cache.CacheStrategy p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='InternalCache']/method[@name='update' and count(parameter)=2 and parameter[1][@type='okhttp3.Response'] and parameter[2][@type='okhttp3.Response']]"
		[Register ("update", "(Lokhttp3/Response;Lokhttp3/Response;)V", "GetUpdate_Lokhttp3_Response_Lokhttp3_Response_Handler:Okhttp3.Internal.Cache.IInternalCacheInvoker, OkHttpBinding")]
		void Update (global::Okhttp3.Response p0, global::Okhttp3.Response p1);

	}

	[global::Android.Runtime.Register ("okhttp3/internal/cache/InternalCache", DoNotGenerateAcw=true)]
	internal partial class IInternalCacheInvoker : global::Java.Lang.Object, IInternalCache {

		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/cache/InternalCache", typeof (IInternalCacheInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "okhttp3.internal.cache.InternalCache"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Okhttp3.Internal.Cache.IInternalCache __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.IInternalCache> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public unsafe global::Okhttp3.Internal.Cache.ICacheRequest Put (global::Okhttp3.Response p0)
		{
			if (id_put_Lokhttp3_Response_ == IntPtr.Zero)
				id_put_Lokhttp3_Response_ = JNIEnv.GetMethodID (class_ref, "put", "(Lokhttp3/Response;)Lokhttp3/internal/cache/CacheRequest;");
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
			global::Okhttp3.Internal.Cache.ICacheRequest __ret = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.ICacheRequest> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_put_Lokhttp3_Response_, __args), JniHandleOwnership.TransferLocalRef);
			return __ret;
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_trackResponse_Lokhttp3_internal_cache_CacheStrategy_;
#pragma warning disable 0169
		static Delegate GetTrackResponse_Lokhttp3_internal_cache_CacheStrategy_Handler ()
		{
			if (cb_trackResponse_Lokhttp3_internal_cache_CacheStrategy_ == null)
				cb_trackResponse_Lokhttp3_internal_cache_CacheStrategy_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_TrackResponse_Lokhttp3_internal_cache_CacheStrategy_);
			return cb_trackResponse_Lokhttp3_internal_cache_CacheStrategy_;
		}

		static void n_TrackResponse_Lokhttp3_internal_cache_CacheStrategy_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Okhttp3.Internal.Cache.IInternalCache __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.IInternalCache> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okhttp3.Internal.Cache.CacheStrategy p0 = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.CacheStrategy> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.TrackResponse (p0);
		}
#pragma warning restore 0169

		IntPtr id_trackResponse_Lokhttp3_internal_cache_CacheStrategy_;
		public unsafe void TrackResponse (global::Okhttp3.Internal.Cache.CacheStrategy p0)
		{
			if (id_trackResponse_Lokhttp3_internal_cache_CacheStrategy_ == IntPtr.Zero)
				id_trackResponse_Lokhttp3_internal_cache_CacheStrategy_ = JNIEnv.GetMethodID (class_ref, "trackResponse", "(Lokhttp3/internal/cache/CacheStrategy;)V");
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_trackResponse_Lokhttp3_internal_cache_CacheStrategy_, __args);
		}
