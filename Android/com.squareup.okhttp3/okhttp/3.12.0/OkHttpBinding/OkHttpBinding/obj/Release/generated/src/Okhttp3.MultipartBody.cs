...
namespace Okhttp3 {
	...
	public sealed partial class MultipartBody : global::Okhttp3.RequestBody {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='MultipartBody']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='okio.BufferedSink']]"
