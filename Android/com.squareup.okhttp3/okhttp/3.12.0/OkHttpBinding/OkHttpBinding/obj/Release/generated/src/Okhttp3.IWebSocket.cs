...
#pragma warning restore 0169
	...
	public partial interface IWebSocket : IJavaObject, IJavaPeerable {
		...
		[Register ("send", "(Lokio/ByteString;)Z", "GetSend_Lokio_ByteString_Handler:Okhttp3.IWebSocketInvoker, OkHttpBinding")]
		bool Send (global::Okio.ByteString p0);
...
#pragma warning restore 0169
		...
		static Delegate cb_send_Lokio_ByteString_;
#pragma warning disable 0169
		static Delegate GetSend_Lokio_ByteString_Handler ()
		{
			if (cb_send_Lokio_ByteString_ == null)
				cb_send_Lokio_ByteString_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, bool>) n_Send_Lokio_ByteString_);
			return cb_send_Lokio_ByteString_;
		}

		static bool n_Send_Lokio_ByteString_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Okhttp3.IWebSocket __this = global::Java.Lang.Object.GetObject<global::Okhttp3.IWebSocket> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		IntPtr id_send_Lokio_ByteString_;
		public unsafe bool Send (global::Okio.ByteString p0)
		{
			if (id_send_Lokio_ByteString_ == IntPtr.Zero)
				id_send_Lokio_ByteString_ = JNIEnv.GetMethodID (class_ref, "send", "(Lokio/ByteString;)Z");
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
			bool __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_send_Lokio_ByteString_, __args);
			return __ret;
		}
