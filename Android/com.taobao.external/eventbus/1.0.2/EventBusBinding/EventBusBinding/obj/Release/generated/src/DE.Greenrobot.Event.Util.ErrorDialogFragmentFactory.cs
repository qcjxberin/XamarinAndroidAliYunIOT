...
#pragma warning disable 0169
			static Delegate GetRawCreateErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_Handler ()
			{
				if (cb_createErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_ == null)
					cb_createErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_RawCreateErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_);
				return cb_createErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_;
			}

			static IntPtr n_RawCreateErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_ (IntPtr jnienv, IntPtr native__this, IntPtr native_e, IntPtr native_arguments)
			{
				...
				IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.RawCreateErrorFragment (e, arguments));
				return __ret;
			}
#pragma warning restore 0169
			...
			[Register ("createErrorFragment", "(Lde/greenrobot/event/util/ThrowableFailureEvent;Landroid/os/Bundle;)Landroid/app/Fragment;", "GetRawCreateErrorFragment_Lde_greenrobot_event_util_ThrowableFailureEvent_Landroid_os_Bundle_Handler")]
			protected virtual unsafe global::Android.App.Fragment RawCreateErrorFragment (global::DE.Greenrobot.Event.Util.ThrowableFailureEvent e, global::Android.OS.Bundle arguments)
			{
