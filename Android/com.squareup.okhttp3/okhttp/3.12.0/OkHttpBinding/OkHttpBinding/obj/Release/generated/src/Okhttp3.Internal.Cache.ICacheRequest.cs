...
namespace Okhttp3.Internal.Cache {
	...
	public partial interface ICacheRequest : IJavaObject, IJavaPeerable {
		...
		[Register ("abort", "()V", "GetAbortHandler:Okhttp3.Internal.Cache.ICacheRequestInvoker, OkHttpBinding")]
		void Abort ();

		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/interface[@name='CacheRequest']/method[@name='body' and count(parameter)=0]"
		[Register ("body", "()Lokio/Sink;", "GetBodyHandler:Okhttp3.Internal.Cache.ICacheRequestInvoker, OkHttpBinding")]
		global::Okio.ISink Body ();
	...
	internal partial class ICacheRequestInvoker : global::Java.Lang.Object, ICacheRequest {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/cache/CacheRequest", typeof (ICacheRequestInvoker));
...
#pragma warning disable 0169
		...
		{
			global::Okhttp3.Internal.Cache.ICacheRequest __this = global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.ICacheRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Abort ();
		}
...
#pragma warning restore 0169
		...
		IntPtr id_body;
		public unsafe global::Okio.ISink Body ()
		{
			if (id_body == IntPtr.Zero)
				id_body = JNIEnv.GetMethodID (class_ref, "body", "()Lokio/Sink;");
			return global::Java.Lang.Object.GetObject<global::Okio.ISink> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_body), JniHandleOwnership.TransferLocalRef);
		}
