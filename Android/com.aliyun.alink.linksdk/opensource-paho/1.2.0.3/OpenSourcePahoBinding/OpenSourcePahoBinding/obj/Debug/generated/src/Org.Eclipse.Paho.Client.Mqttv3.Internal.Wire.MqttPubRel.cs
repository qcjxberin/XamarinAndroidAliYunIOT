...
namespace Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire {
	...
	public partial class MqttPubRel : global::Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire.MqttPersistableWireMessage {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/paho/client/mqttv3/internal/wire/MqttPubRel", typeof (MqttPubRel));
		...
		public unsafe MqttPubRel (global::Org.Eclipse.Paho.Client.Mqttv3.Internal.Wire.MqttPubRec pubRec)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lorg/eclipse/paho/client/mqttv3/internal/wire/MqttPubRec;)V";
			...
			try {
				...
				__args [0] = new JniArgumentValue ((pubRec == null) ? IntPtr.Zero : ((global::Java.Lang.Object) pubRec).Handle);
				var __r = _members.InstanceMethods.StartCreateInstance (__id, ((object) this).GetType (), __args);
				SetHandle (__r.Handle, JniHandleOwnership.TransferLocalRef);
				_members.InstanceMethods.FinishCreateInstance (__id, this, __args);
			} finally {
