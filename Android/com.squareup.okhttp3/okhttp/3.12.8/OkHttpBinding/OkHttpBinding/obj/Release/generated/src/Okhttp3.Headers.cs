...
namespace Okhttp3 {
	...
	public sealed partial class Headers : global::Java.Lang.Object {
		...
		public sealed partial class Builder : global::Java.Lang.Object {
			...
			{
				const string __id = "add.(Ljava/lang/String;Ljava/util/Date;)Lokhttp3/Headers$Builder;";
				IntPtr native_name = JNIEnv.NewString (name);
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [2];
					__args [0] = new JniArgumentValue (native_name);
			...
			{
				const string __id = "addAll.(Lokhttp3/Headers;)Lokhttp3/Headers$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
			...
			{
				const string __id = "addUnsafeNonAscii.(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Headers$Builder;";
				IntPtr native_name = JNIEnv.NewString (name);
				IntPtr native_value = JNIEnv.NewString (value);
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [2];
			...
			{
				const string __id = "set.(Ljava/lang/String;Ljava/util/Date;)Lokhttp3/Headers$Builder;";
				IntPtr native_name = JNIEnv.NewString (name);
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [2];
					__args [0] = new JniArgumentValue (native_name);
