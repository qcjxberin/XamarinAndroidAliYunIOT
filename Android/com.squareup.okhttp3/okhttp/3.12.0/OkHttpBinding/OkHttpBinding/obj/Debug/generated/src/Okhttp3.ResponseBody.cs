...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='ResponseBody']/method[@name='create' and count(parameter)=3 and parameter[1][@type='okhttp3.MediaType'] and parameter[2][@type='long'] and parameter[3][@type='okio.BufferedSource']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='ResponseBody']/method[@name='create' and count(parameter)=2 and parameter[1][@type='okhttp3.MediaType'] and parameter[2][@type='okio.ByteString']]"
		[Register ("create", "(Lokhttp3/MediaType;Lokio/ByteString;)Lokhttp3/ResponseBody;", "")]
		public static unsafe global::Okhttp3.ResponseBody Create (global::Okhttp3.MediaType contentType, global::Okio.ByteString content)
		{
			const string __id = "create.(Lokhttp3/MediaType;Lokio/ByteString;)Lokhttp3/ResponseBody;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue ((contentType == null) ? IntPtr.Zero : ((global::Java.Lang.Object) contentType).Handle);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='ResponseBody']/method[@name='source' and count(parameter)=0]"
		[Register ("source", "()Lokio/BufferedSource;", "GetSourceHandler")]
		public abstract global::Okio.IBufferedSource Source ();
