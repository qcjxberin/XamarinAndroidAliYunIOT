...
namespace Com.Alibaba.Sdk.Android.Oss.Network {
	...
	public partial class ExecutionContext : global::Java.Lang.Object {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.alibaba.sdk.android.oss.network']/class[@name='ExecutionContext']/constructor[@name='ExecutionContext' and count(parameter)=2 and parameter[1][@type='okhttp3.OkHttpClient'] and parameter[2][@type='Request']]"
		[Register (".ctor", "(Lokhttp3/OkHttpClient;Lcom/alibaba/sdk/android/oss/model/OSSRequest;)V", "")]
		public unsafe ExecutionContext (global::Okhttp3.OkHttpClient client, global::Java.Lang.Object request)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lokhttp3/OkHttpClient;Lcom/alibaba/sdk/android/oss/model/OSSRequest;)V";
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.alibaba.sdk.android.oss.network']/class[@name='ExecutionContext']/constructor[@name='ExecutionContext' and count(parameter)=3 and parameter[1][@type='okhttp3.OkHttpClient'] and parameter[2][@type='Request'] and parameter[3][@type='android.content.Context']]"
		[Register (".ctor", "(Lokhttp3/OkHttpClient;Lcom/alibaba/sdk/android/oss/model/OSSRequest;Landroid/content/Context;)V", "")]
		public unsafe ExecutionContext (global::Okhttp3.OkHttpClient client, global::Java.Lang.Object request, global::Android.Content.Context applicationContext)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lokhttp3/OkHttpClient;Lcom/alibaba/sdk/android/oss/model/OSSRequest;Landroid/content/Context;)V";
			...
			try {
				...
				__args [0] = new JniArgumentValue ((client == null) ? IntPtr.Zero : ((global::Java.Lang.Object) client).Handle);
				__args [1] = new JniArgumentValue (native_request);
				__args [2] = new JniArgumentValue ((applicationContext == null) ? IntPtr.Zero : ((global::Java.Lang.Object) applicationContext).Handle);
				var __r = _members.InstanceMethods.StartCreateInstance (__id, ((object) this).GetType (), __args);
				SetHandle (__r.Handle, JniHandleOwnership.TransferLocalRef);
				_members.InstanceMethods.FinishCreateInstance (__id, this, __args);
			} finally {
...
#pragma warning restore 0169
		...
		static Delegate cb_setClient_Lokhttp3_OkHttpClient_;
#pragma warning disable 0169
		static Delegate GetSetClient_Lokhttp3_OkHttpClient_Handler ()
		{
			if (cb_setClient_Lokhttp3_OkHttpClient_ == null)
				cb_setClient_Lokhttp3_OkHttpClient_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetClient_Lokhttp3_OkHttpClient_);
			return cb_setClient_Lokhttp3_OkHttpClient_;
		}

		static void n_SetClient_Lokhttp3_OkHttpClient_ (IntPtr jnienv, IntPtr native__this, IntPtr native_client)
		{
			global::Com.Alibaba.Sdk.Android.Oss.Network.ExecutionContext __this = global::Java.Lang.Object.GetObject<global::Com.Alibaba.Sdk.Android.Oss.Network.ExecutionContext> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okhttp3.OkHttpClient client = global::Java.Lang.Object.GetObject<global::Okhttp3.OkHttpClient> (native_client, JniHandleOwnership.DoNotTransfer);
			__this.Client = client;
		}
#pragma warning restore 0169

		public virtual unsafe global::Okhttp3.OkHttpClient Client {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.sdk.android.oss.network']/class[@name='ExecutionContext']/method[@name='getClient' and count(parameter)=0]"
			[Register ("getClient", "()Lokhttp3/OkHttpClient;", "GetGetClientHandler")]
			get {
				const string __id = "getClient.()Lokhttp3/OkHttpClient;";
				try {
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, null);
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.sdk.android.oss.network']/class[@name='ExecutionContext']/method[@name='setClient' and count(parameter)=1 and parameter[1][@type='okhttp3.OkHttpClient']]"
			[Register ("setClient", "(Lokhttp3/OkHttpClient;)V", "GetSetClient_Lokhttp3_OkHttpClient_Handler")]
			set {
				const string __id = "setClient.(Lokhttp3/OkHttpClient;)V";
				try {
