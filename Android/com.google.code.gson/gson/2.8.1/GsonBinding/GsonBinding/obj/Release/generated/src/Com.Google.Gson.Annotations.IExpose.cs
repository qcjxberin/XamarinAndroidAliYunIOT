...
namespace Com.Google.Gson.Annotations {
	...
	public partial interface IExpose : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("deserialize", "()Z", "GetDeserializeHandler:Com.Google.Gson.Annotations.IExposeInvoker, GsonBinding")]
		bool Deserialize ();
		...
		[Register ("serialize", "()Z", "GetSerializeHandler:Com.Google.Gson.Annotations.IExposeInvoker, GsonBinding")]
		bool Serialize ();

	}

	[global::Android.Runtime.Register ("com/google/gson/annotations/Expose", DoNotGenerateAcw=true)]
	internal partial class IExposeInvoker : global::Java.Lang.Object, IExpose {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/gson/annotations/Expose", typeof (IExposeInvoker));
