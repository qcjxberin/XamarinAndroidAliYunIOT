...
namespace Okio {
	...
	public sealed partial class HashingSource : global::Okio.ForwardingSource {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='HashingSource']/method[@name='hmacSha1' and count(parameter)=2 and parameter[1][@type='okio.Source'] and parameter[2][@type='okio.ByteString']]"
		[Register ("hmacSha1", "(Lokio/Source;Lokio/ByteString;)Lokio/HashingSource;", "")]
		public static unsafe global::Okio.HashingSource HmacSha1 (global::Okio.ISource source, global::Okio.ByteString key)
		{
			const string __id = "hmacSha1.(Lokio/Source;Lokio/ByteString;)Lokio/HashingSource;";
			try {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='HashingSource']/method[@name='hmacSha256' and count(parameter)=2 and parameter[1][@type='okio.Source'] and parameter[2][@type='okio.ByteString']]"
