...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='encodeString' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.nio.charset.Charset']]"
		[Register ("encodeString", "(Ljava/lang/String;Ljava/nio/charset/Charset;)Lokio/ByteString;", "")]
		public static unsafe global::Okio.ByteString EncodeString (string s, global::Java.Nio.Charset.Charset charset)
		{
			const string __id = "encodeString.(Ljava/lang/String;Ljava/nio/charset/Charset;)Lokio/ByteString;";
		...
		public unsafe bool EndsWith (global::Okio.ByteString suffix)
		{
			const string __id = "endsWith.(Lokio/ByteString;)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((suffix == null) ? IntPtr.Zero : ((global::Java.Lang.Object) suffix).Handle);
				var __rm = _members.InstanceMethods.InvokeNonvirtualBooleanMethod (__id, this, __args);
				return __rm;
			} finally {
			}
...
#pragma warning restore 0169
		...
		static Delegate cb_hmacSha1_Lokio_ByteString_;
#pragma warning disable 0169
		static Delegate GetHmacSha1_Lokio_ByteString_Handler ()
		{
			if (cb_hmacSha1_Lokio_ByteString_ == null)
				cb_hmacSha1_Lokio_ByteString_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_HmacSha1_Lokio_ByteString_);
			return cb_hmacSha1_Lokio_ByteString_;
		}

		static IntPtr n_HmacSha1_Lokio_ByteString_ (IntPtr jnienv, IntPtr native__this, IntPtr native_key)
		{
			global::Okio.ByteString __this = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okio.ByteString key = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (native_key, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.HmacSha1 (key));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='hmacSha1' and count(parameter)=1 and parameter[1][@type='okio.ByteString']]"
		[Register ("hmacSha1", "(Lokio/ByteString;)Lokio/ByteString;", "GetHmacSha1_Lokio_ByteString_Handler")]
		public virtual unsafe global::Okio.ByteString HmacSha1 (global::Okio.ByteString key)
		{
		...
		static Delegate cb_hmacSha256_Lokio_ByteString_;
#pragma warning disable 0169
		static Delegate GetHmacSha256_Lokio_ByteString_Handler ()
		{
			if (cb_hmacSha256_Lokio_ByteString_ == null)
				cb_hmacSha256_Lokio_ByteString_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_HmacSha256_Lokio_ByteString_);
			return cb_hmacSha256_Lokio_ByteString_;
		}

		static IntPtr n_HmacSha256_Lokio_ByteString_ (IntPtr jnienv, IntPtr native__this, IntPtr native_key)
		{
			global::Okio.ByteString __this = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okio.ByteString key = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (native_key, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.HmacSha256 (key));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='hmacSha256' and count(parameter)=1 and parameter[1][@type='okio.ByteString']]"
		[Register ("hmacSha256", "(Lokio/ByteString;)Lokio/ByteString;", "GetHmacSha256_Lokio_ByteString_Handler")]
		public virtual unsafe global::Okio.ByteString HmacSha256 (global::Okio.ByteString key)
		{
		...
		static Delegate cb_hmacSha512_Lokio_ByteString_;
#pragma warning disable 0169
		static Delegate GetHmacSha512_Lokio_ByteString_Handler ()
		{
			if (cb_hmacSha512_Lokio_ByteString_ == null)
				cb_hmacSha512_Lokio_ByteString_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_HmacSha512_Lokio_ByteString_);
			return cb_hmacSha512_Lokio_ByteString_;
		}

		static IntPtr n_HmacSha512_Lokio_ByteString_ (IntPtr jnienv, IntPtr native__this, IntPtr native_key)
		{
			global::Okio.ByteString __this = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okio.ByteString key = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (native_key, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.HmacSha512 (key));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='hmacSha512' and count(parameter)=1 and parameter[1][@type='okio.ByteString']]"
		[Register ("hmacSha512", "(Lokio/ByteString;)Lokio/ByteString;", "GetHmacSha512_Lokio_ByteString_Handler")]
		public virtual unsafe global::Okio.ByteString HmacSha512 (global::Okio.ByteString key)
		{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='of' and count(parameter)=1 and parameter[1][@type='java.nio.ByteBuffer']]"
		[Register ("of", "(Ljava/nio/ByteBuffer;)Lokio/ByteString;", "")]
		public static unsafe global::Okio.ByteString Of (global::Java.Nio.ByteBuffer data)
		{
			const string __id = "of.(Ljava/nio/ByteBuffer;)Lokio/ByteString;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
...
#pragma warning restore 0169
		...
		static Delegate cb_sha512;
#pragma warning disable 0169
		static Delegate GetSha512Handler ()
		{
			if (cb_sha512 == null)
				cb_sha512 = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_Sha512);
			return cb_sha512;
		}

		static IntPtr n_Sha512 (IntPtr jnienv, IntPtr native__this)
		{
			global::Okio.ByteString __this = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Sha512 ());
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='sha512' and count(parameter)=0]"
		[Register ("sha512", "()Lokio/ByteString;", "GetSha512Handler")]
		public virtual unsafe global::Okio.ByteString Sha512 ()
		{
...
#pragma warning restore 0169
		...
		static Delegate cb_string_Ljava_nio_charset_Charset_;
#pragma warning disable 0169
		static Delegate GetString_Ljava_nio_charset_Charset_Handler ()
		{
			if (cb_string_Ljava_nio_charset_Charset_ == null)
				cb_string_Ljava_nio_charset_Charset_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_String_Ljava_nio_charset_Charset_);
			return cb_string_Ljava_nio_charset_Charset_;
		}

		static IntPtr n_String_Ljava_nio_charset_Charset_ (IntPtr jnienv, IntPtr native__this, IntPtr native_charset)
		{
			global::Okio.ByteString __this = global::Java.Lang.Object.GetObject<global::Okio.ByteString> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			IntPtr __ret = JNIEnv.NewString (__this.String (charset));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='okio']/class[@name='ByteString']/method[@name='string' and count(parameter)=1 and parameter[1][@type='java.nio.charset.Charset']]"
		[Register ("string", "(Ljava/nio/charset/Charset;)Ljava/lang/String;", "GetString_Ljava_nio_charset_Charset_Handler")]
		public virtual unsafe string String (global::Java.Nio.Charset.Charset charset)
		{
			const string __id = "string.(Ljava/nio/charset/Charset;)Ljava/lang/String;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
