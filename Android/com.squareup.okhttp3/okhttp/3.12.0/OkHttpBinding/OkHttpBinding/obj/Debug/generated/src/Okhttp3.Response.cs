...
#pragma warning disable 0169
			static Delegate GetReceivedResponseAtMillis_JHandler ()
			{
				if (cb_receivedResponseAtMillis_J == null)
					cb_receivedResponseAtMillis_J = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, long, IntPtr>) n_ReceivedResponseAtMillis_J);
...
#pragma warning restore 0169
			...
			{
				const string __id = "receivedResponseAtMillis.(J)Lokhttp3/Response$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (receivedResponseAtMillis);
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
					return global::Java.Lang.Object.GetObject<global::Okhttp3.Response.Builder> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
...
#pragma warning disable 0169
			static Delegate GetSentRequestAtMillis_JHandler ()
			{
				if (cb_sentRequestAtMillis_J == null)
					cb_sentRequestAtMillis_J = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, long, IntPtr>) n_SentRequestAtMillis_J);
...
#pragma warning restore 0169
			...
			{
				const string __id = "sentRequestAtMillis.(J)Lokhttp3/Response$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (sentRequestAtMillis);
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
					return global::Java.Lang.Object.GetObject<global::Okhttp3.Response.Builder> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
		...
		{
			const string __id = "receivedResponseAtMillis.()J";
			try {
		...
		{
			const string __id = "sentRequestAtMillis.()J";
			try {
				var __rm = _members.InstanceMethods.InvokeAbstractInt64Method (__id, this, null);
				return __rm;
			} finally {
