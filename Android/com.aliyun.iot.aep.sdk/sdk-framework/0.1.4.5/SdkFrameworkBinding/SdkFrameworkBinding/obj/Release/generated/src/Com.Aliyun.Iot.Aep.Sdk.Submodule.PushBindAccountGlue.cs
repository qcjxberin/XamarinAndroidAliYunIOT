...
namespace Com.Aliyun.Iot.Aep.Sdk.Submodule {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.submodule']/class[@name='PushBindAccountGlue']"
	[global::Android.Runtime.Register ("com/aliyun/iot/aep/sdk/submodule/PushBindAccountGlue", DoNotGenerateAcw=true)]
	public partial class PushBindAccountGlue : global::Com.Aliyun.Iot.Aep.Sdk.Framework.Sdk.SimpleSDKDelegateImp {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/aliyun/iot/aep/sdk/submodule/PushBindAccountGlue", typeof (PushBindAccountGlue));
		...
		protected PushBindAccountGlue (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.submodule']/class[@name='PushBindAccountGlue']/constructor[@name='PushBindAccountGlue' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushBindAccountGlue ()
...
#pragma warning disable 0169
		...
		static int n_Init_Landroid_app_Application_Lcom_aliyun_iot_aep_sdk_framework_sdk_SDKConfigure_Ljava_util_Map_ (IntPtr jnienv, IntPtr native__this, IntPtr native_app, IntPtr native_sdkConfigure, IntPtr native_map)
		{
			global::Com.Aliyun.Iot.Aep.Sdk.Submodule.PushBindAccountGlue __this = global::Java.Lang.Object.GetObject<global::Com.Aliyun.Iot.Aep.Sdk.Submodule.PushBindAccountGlue> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			int __ret = __this.Init (app, sdkConfigure, map);
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.submodule']/class[@name='PushBindAccountGlue']/method[@name='init' and count(parameter)=3 and parameter[1][@type='android.app.Application'] and parameter[2][@type='com.aliyun.iot.aep.sdk.framework.sdk.SDKConfigure'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;']]"
		...
		public override unsafe int Init (global::Android.App.Application app, global::Com.Aliyun.Iot.Aep.Sdk.Framework.Sdk.SDKConfigure sdkConfigure, global::System.Collections.Generic.IDictionary<string, string> map)
		{
