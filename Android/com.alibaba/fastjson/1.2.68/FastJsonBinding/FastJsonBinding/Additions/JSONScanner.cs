...
{
    public sealed partial class JSONScanner : global::Com.Alibaba.Fastjson.Parser.JSONLexerBase
    {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.fastjson.parser']/class[@name='JSONScanner']/method[@name='charArrayCompare' and count(parameter)=1 and parameter[1][@type='char[]']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.fastjson.parser']/class[@name='JSONScanner']/method[@name='sub_chars' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
