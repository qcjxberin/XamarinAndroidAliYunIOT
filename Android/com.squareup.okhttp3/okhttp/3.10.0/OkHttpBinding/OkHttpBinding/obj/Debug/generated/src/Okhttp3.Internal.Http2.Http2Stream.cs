...
namespace Okhttp3.Internal.Http2 {
	...
	public sealed partial class Http2Stream : global::Java.Lang.Object {
		...
		public unsafe global::System.Collections.Generic.IList<global::Okhttp3.Internal.Http2.Header> RequestHeaders {
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Stream']/method[@name='getRequestHeaders' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Stream']/method[@name='sendResponseHeaders' and count(parameter)=2 and parameter[1][@type='java.util.List&lt;okhttp3.internal.http2.Header&gt;'] and parameter[2][@type='boolean']]"
		[Register ("sendResponseHeaders", "(Ljava/util/List;Z)V", "")]
		public unsafe void SendResponseHeaders (global::System.Collections.Generic.IList<global::Okhttp3.Internal.Http2.Header> responseHeaders, bool @out)
		{
			const string __id = "sendResponseHeaders.(Ljava/util/List;Z)V";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Stream']/method[@name='takeResponseHeaders' and count(parameter)=0]"
		[Register ("takeResponseHeaders", "()Ljava/util/List;", "")]
		public unsafe global::System.Collections.Generic.IList<global::Okhttp3.Internal.Http2.Header> TakeResponseHeaders ()
		{
			const string __id = "takeResponseHeaders.()Ljava/util/List;";
			try {
				var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
				return global::Android.Runtime.JavaList<global::Okhttp3.Internal.Http2.Header>.FromJniHandle (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
