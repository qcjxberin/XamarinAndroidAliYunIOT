...
namespace Okhttp3.Internal {
	...
	public sealed partial class Util : global::Java.Lang.Object {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Util']/method[@name='bomAwareCharset' and count(parameter)=2 and parameter[1][@type='okio.BufferedSource'] and parameter[2][@type='java.nio.charset.Charset']]"
		[Register ("bomAwareCharset", "(Lokio/BufferedSource;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Util']/method[@name='discard' and count(parameter)=3 and parameter[1][@type='okio.Source'] and parameter[2][@type='int'] and parameter[3][@type='java.util.concurrent.TimeUnit']]"
		[Register ("discard", "(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z", "")]
		public static unsafe bool Discard (global::Okio.ISource source, int timeout, global::Java.Util.Concurrent.TimeUnit timeUnit)
		{
			const string __id = "discard.(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [3];
				__args [0] = new JniArgumentValue ((source == null) ? IntPtr.Zero : ((global::Java.Lang.Object) source).Handle);
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal']/class[@name='Util']/method[@name='skipAll' and count(parameter)=3 and parameter[1][@type='okio.Source'] and parameter[2][@type='int'] and parameter[3][@type='java.util.concurrent.TimeUnit']]"
		[Register ("skipAll", "(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z", "")]
