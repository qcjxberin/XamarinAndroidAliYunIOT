...
namespace Com.TA.Utdid2.Device {
	...
	public partial class UTDevice : global::Java.Lang.Object {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ta/utdid2/device/UTDevice", typeof (UTDevice));
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ta.utdid2.device']/class[@name='UTDevice']/method[@name='getUtdidForUpdate' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("getUtdidForUpdate", "(Landroid/content/Context;)Ljava/lang/String;", "")]
		public static unsafe string GetUtdidForUpdate (global::Android.Content.Context context)
		{
			const string __id = "getUtdidForUpdate.(Landroid/content/Context;)Ljava/lang/String;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((context == null) ? IntPtr.Zero : ((global::Java.Lang.Object) context).Handle);
				var __rm = _members.StaticMethods.InvokeObjectMethod (__id, __args);
