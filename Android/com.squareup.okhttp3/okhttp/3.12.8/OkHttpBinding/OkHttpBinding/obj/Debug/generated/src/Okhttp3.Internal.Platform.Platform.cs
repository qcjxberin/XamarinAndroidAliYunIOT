...
namespace Okhttp3.Internal.Platform {
	...
	public partial class Platform : global::Java.Lang.Object {
		...
		public static unsafe bool IsConscryptPreferred {
			...
			get {
				const string __id = "isConscryptPreferred.()Z";
				try {
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Javax.Net.Ssl.SSLContext SSLContext {
			...
			get {
				const string __id = "getSSLContext.()Ljavax/net/ssl/SSLContext;";
				try {
					var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, null);
					return global::Java.Lang.Object.GetObject<global::Javax.Net.Ssl.SSLContext> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		static Delegate GetBuildCertificateChainCleaner_Ljavax_net_ssl_SSLSocketFactory_Handler ()
		{
			if (cb_buildCertificateChainCleaner_Ljavax_net_ssl_SSLSocketFactory_ == null)
				cb_buildCertificateChainCleaner_Ljavax_net_ssl_SSLSocketFactory_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_BuildCertificateChainCleaner_Ljavax_net_ssl_SSLSocketFactory_);
...
#pragma warning disable 0169
		static Delegate GetBuildTrustRootIndex_Ljavax_net_ssl_X509TrustManager_Handler ()
		{
			if (cb_buildTrustRootIndex_Ljavax_net_ssl_X509TrustManager_ == null)
				cb_buildTrustRootIndex_Ljavax_net_ssl_X509TrustManager_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_BuildTrustRootIndex_Ljavax_net_ssl_X509TrustManager_);
...
#pragma warning restore 0169
		...
		{
			const string __id = "buildTrustRootIndex.(Ljavax/net/ssl/X509TrustManager;)Lokhttp3/internal/tls/TrustRootIndex;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((trustManager == null) ? IntPtr.Zero : ((global::Java.Lang.Object) trustManager).Handle);
				var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Tls.ITrustRootIndex> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning disable 0169
		static Delegate GetConfigureSslSocketFactory_Ljavax_net_ssl_SSLSocketFactory_Handler ()
		{
			if (cb_configureSslSocketFactory_Ljavax_net_ssl_SSLSocketFactory_ == null)
				cb_configureSslSocketFactory_Ljavax_net_ssl_SSLSocketFactory_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_ConfigureSslSocketFactory_Ljavax_net_ssl_SSLSocketFactory_);
...
#pragma warning disable 0169
		static Delegate GetGetStackTraceForCloseable_Ljava_lang_String_Handler ()
		{
			if (cb_getStackTraceForCloseable_Ljava_lang_String_ == null)
				cb_getStackTraceForCloseable_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_GetStackTraceForCloseable_Ljava_lang_String_);
...
#pragma warning restore 0169
		...
		{
			const string __id = "getStackTraceForCloseable.(Ljava/lang/String;)Ljava/lang/Object;";
			IntPtr native_closer = JNIEnv.NewString (closer);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (native_closer);
				var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
...
#pragma warning disable 0169
		static Delegate GetLogCloseableLeak_Ljava_lang_String_Ljava_lang_Object_Handler ()
		{
			if (cb_logCloseableLeak_Ljava_lang_String_Ljava_lang_Object_ == null)
				cb_logCloseableLeak_Ljava_lang_String_Ljava_lang_Object_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, IntPtr>) n_LogCloseableLeak_Ljava_lang_String_Ljava_lang_Object_);
...
#pragma warning restore 0169
		...
		{
			const string __id = "logCloseableLeak.(Ljava/lang/String;Ljava/lang/Object;)V";
			IntPtr native_message = JNIEnv.NewString (message);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue (native_message);
				__args [1] = new JniArgumentValue ((stackTrace == null) ? IntPtr.Zero : ((global::Java.Lang.Object) stackTrace).Handle);
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_message);
			}
