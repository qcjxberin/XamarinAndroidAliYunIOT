...
namespace Com.Aliyun.Iot.Aep.Sdk.Submodule {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.submodule']/class[@name='DeviceCenterGlue']"
	[global::Android.Runtime.Register ("com/aliyun/iot/aep/sdk/submodule/DeviceCenterGlue", DoNotGenerateAcw=true)]
	public partial class DeviceCenterGlue : global::Com.Aliyun.Iot.Aep.Sdk.Framework.Sdk.SimpleSDKDelegateImp {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/aliyun/iot/aep/sdk/submodule/DeviceCenterGlue", typeof (DeviceCenterGlue));
		...
		protected DeviceCenterGlue (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.submodule']/class[@name='DeviceCenterGlue']/constructor[@name='DeviceCenterGlue' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DeviceCenterGlue ()
...
#pragma warning disable 0169
		...
		{
			global::Com.Aliyun.Iot.Aep.Sdk.Submodule.DeviceCenterGlue __this = global::Java.Lang.Object.GetObject<global::Com.Aliyun.Iot.Aep.Sdk.Submodule.DeviceCenterGlue> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.aliyun.iot.aep.sdk.submodule']/class[@name='DeviceCenterGlue']/method[@name='init' and count(parameter)=3 and parameter[1][@type='android.app.Application'] and parameter[2][@type='com.aliyun.iot.aep.sdk.framework.sdk.SDKConfigure'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.String&gt;']]"
