...
namespace Com.Alibaba.Sdk.Android.Oss.Internal {
	...
	public partial class ResponseMessage : global::Com.Alibaba.Sdk.Android.Oss.Internal.HttpMessage {
...
#pragma warning restore 0169
		...
		static Delegate cb_setResponse_Lokhttp3_Response_;
#pragma warning disable 0169
		static Delegate GetSetResponse_Lokhttp3_Response_Handler ()
		{
			if (cb_setResponse_Lokhttp3_Response_ == null)
				cb_setResponse_Lokhttp3_Response_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetResponse_Lokhttp3_Response_);
			return cb_setResponse_Lokhttp3_Response_;
		}

		static void n_SetResponse_Lokhttp3_Response_ (IntPtr jnienv, IntPtr native__this, IntPtr native_response)
		{
			global::Com.Alibaba.Sdk.Android.Oss.Internal.ResponseMessage __this = global::Java.Lang.Object.GetObject<global::Com.Alibaba.Sdk.Android.Oss.Internal.ResponseMessage> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Okhttp3.Response Response {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.sdk.android.oss.internal']/class[@name='ResponseMessage']/method[@name='getResponse' and count(parameter)=0]"
			[Register ("getResponse", "()Lokhttp3/Response;", "GetGetResponseHandler")]
			get {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.alibaba.sdk.android.oss.internal']/class[@name='ResponseMessage']/method[@name='setResponse' and count(parameter)=1 and parameter[1][@type='okhttp3.Response']]"
			[Register ("setResponse", "(Lokhttp3/Response;)V", "GetSetResponse_Lokhttp3_Response_Handler")]
			set {
				const string __id = "setResponse.(Lokhttp3/Response;)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue ((value == null) ? IntPtr.Zero : ((global::Java.Lang.Object) value).Handle);
					_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
