...
namespace Com.Facebook.Common.Executors
{
	...
	internal partial class ISerialExecutorServiceInvoker : global::Java.Lang.Object, ISerialExecutorService
	{

		static readonly JniPeerMembers _members = new XAPeerMembers("com/facebook/common/executors/SerialExecutorService", typeof(ISerialExecutorServiceInvoker));
...
#pragma warning restore 0169
		...
		public unsafe global::System.Collections.Generic.IList<global::Java.Lang.IRunnable> ShutdownNow()
		{
			...
			var rawResult = global::Android.Runtime.JavaList.FromJniHandle(JNIEnv.CallObjectMethod(((global::Java.Lang.Object)this).Handle, id_shutdownNow), JniHandleOwnership.TransferLocalRef);
			return (global::System.Collections.Generic.IList<global::Java.Lang.IRunnable>)rawResult;
		}
