...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='RequestBody']/method[@name='create' and count(parameter)=2 and parameter[1][@type='okhttp3.MediaType'] and parameter[2][@type='okio.ByteString']]"
		[Register ("create", "(Lokhttp3/MediaType;Lokio/ByteString;)Lokhttp3/RequestBody;", "")]
		public static unsafe global::Okhttp3.RequestBody Create (global::Okhttp3.MediaType contentType, global::Okio.ByteString content)
		{
			const string __id = "create.(Lokhttp3/MediaType;Lokio/ByteString;)Lokhttp3/RequestBody;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue ((contentType == null) ? IntPtr.Zero : ((global::Java.Lang.Object) contentType).Handle);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='RequestBody']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='okio.BufferedSink']]"
	...
	internal partial class RequestBodyInvoker : RequestBody {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3']/class[@name='RequestBody']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='okio.BufferedSink']]"
		[Register ("writeTo", "(Lokio/BufferedSink;)V", "GetWriteTo_Lokio_BufferedSink_Handler")]
		public override unsafe void WriteTo (global::Okio.IBufferedSink p0)
		{
