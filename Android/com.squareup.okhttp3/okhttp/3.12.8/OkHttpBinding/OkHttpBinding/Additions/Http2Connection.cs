...
namespace Okhttp3.Internal.Http2
{
	public sealed partial class Http2Connection : global::Java.Lang.Object, global::Java.IO.ICloseable
	{
		...
		{
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.http2']/class[@name='Http2Connection.IntervalPingRunnable']/method[@name='execute' and count(parameter)=0]"
			[Register("execute", "()V", "")]
			protected override unsafe void Execute()
			{
				const string __id = "execute.()V";
