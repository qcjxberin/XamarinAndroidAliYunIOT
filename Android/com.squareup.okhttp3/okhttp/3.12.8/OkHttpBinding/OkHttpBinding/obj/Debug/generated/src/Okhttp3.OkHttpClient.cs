...
namespace Okhttp3 {
	...
	public partial class OkHttpClient : global::Java.Lang.Object, global::Java.Lang.ICloneable, global::Okhttp3.ICallFactory, global::Okhttp3.IWebSocketFactory {
		...
		public sealed partial class Builder : global::Java.Lang.Object {
			...
			{
				const string __id = "callTimeout.(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;";
				try {
			...
			{
				const string __id = "eventListener.(Lokhttp3/EventListener;)Lokhttp3/OkHttpClient$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
			...
			{
				const string __id = "eventListenerFactory.(Lokhttp3/EventListener$Factory;)Lokhttp3/OkHttpClient$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue ((eventListenerFactory == null) ? IntPtr.Zero : ((global::Java.Lang.Object) eventListenerFactory).Handle);
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
					return global::Java.Lang.Object.GetObject<global::Okhttp3.OkHttpClient.Builder> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			...
			{
				const string __id = "pingInterval.(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [2];
...
#pragma warning disable 0169
		static Delegate GetCallTimeoutMillisHandler ()
		{
			if (cb_callTimeoutMillis == null)
				cb_callTimeoutMillis = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int>) n_CallTimeoutMillis);
...
#pragma warning restore 0169
		...
		{
			const string __id = "callTimeoutMillis.()I";
			try {
...
#pragma warning disable 0169
		static Delegate GetEventListenerFactoryHandler ()
		{
			if (cb_eventListenerFactory == null)
				cb_eventListenerFactory = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_EventListenerFactory);
...
#pragma warning restore 0169
		...
		{
			const string __id = "eventListenerFactory.()Lokhttp3/EventListener$Factory;";
			try {
				var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, null);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.EventListener.IFactory> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		static IntPtr n_NewWebSocket_Lokhttp3_Request_Lokhttp3_WebSocketListener_ (IntPtr jnienv, IntPtr native__this, IntPtr native_request, IntPtr native_listener)
		{
			global::Okhttp3.OkHttpClient __this = global::Java.Lang.Object.GetObject<global::Okhttp3.OkHttpClient> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Okhttp3.Request request = global::Java.Lang.Object.GetObject<global::Okhttp3.Request> (native_request, JniHandleOwnership.DoNotTransfer);
			global::Okhttp3.WebSocketListener listener = global::Java.Lang.Object.GetObject<global::Okhttp3.WebSocketListener> (native_listener, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		{
			const string __id = "newWebSocket.(Lokhttp3/Request;Lokhttp3/WebSocketListener;)Lokhttp3/WebSocket;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue ((request == null) ? IntPtr.Zero : ((global::Java.Lang.Object) request).Handle);
				__args [1] = new JniArgumentValue ((listener == null) ? IntPtr.Zero : ((global::Java.Lang.Object) listener).Handle);
				var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.IWebSocket> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning disable 0169
		static Delegate GetPingIntervalMillisHandler ()
		{
			if (cb_pingIntervalMillis == null)
				cb_pingIntervalMillis = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int>) n_PingIntervalMillis);
...
#pragma warning restore 0169
		...
		{
			const string __id = "pingIntervalMillis.()I";
			try {
				var __rm = _members.InstanceMethods.InvokeVirtualInt32Method (__id, this, null);
				return __rm;
			} finally {
