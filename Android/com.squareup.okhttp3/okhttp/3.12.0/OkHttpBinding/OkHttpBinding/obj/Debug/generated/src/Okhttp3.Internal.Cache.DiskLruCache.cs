...
namespace Okhttp3.Internal.Cache {
	...
	public sealed partial class DiskLruCache : global::Java.Lang.Object, global::Java.IO.ICloseable, global::Java.IO.IFlushable {
		...
		public sealed partial class Editor : global::Java.Lang.Object {
			...
			static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/cache/DiskLruCache$Editor", typeof (Editor));
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/class[@name='DiskLruCache.Editor']/method[@name='newSink' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("newSink", "(I)Lokio/Sink;", "")]
			public unsafe global::Okio.ISink NewSink (int index)
			{
				const string __id = "newSink.(I)Lokio/Sink;";
				try {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/class[@name='DiskLruCache.Editor']/method[@name='newSource' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("newSource", "(I)Lokio/Source;", "")]
			public unsafe global::Okio.ISource NewSource (int index)
			{
				const string __id = "newSource.(I)Lokio/Source;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (index);
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
		...
		public sealed partial class Snapshot : global::Java.Lang.Object, global::Java.IO.ICloseable {
			...
			static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/cache/DiskLruCache$Snapshot", typeof (Snapshot));
			internal static new IntPtr class_ref {
				get {
					return _members.JniPeerType.PeerReference.Handle;
				}
			...
			{
				const string __id = "edit.()Lokhttp3/internal/cache/DiskLruCache$Editor;";
				try {
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
					return global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.DiskLruCache.Editor> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='okhttp3.internal.cache']/class[@name='DiskLruCache.Snapshot']/method[@name='getSource' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("getSource", "(I)Lokio/Source;", "")]
			public unsafe global::Okio.ISource GetSource (int index)
			{
				const string __id = "getSource.(I)Lokio/Source;";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue (index);
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("okhttp3/internal/cache/DiskLruCache", typeof (DiskLruCache));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
		...
		{
			const string __id = "edit.(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Editor;";
		...
		{
			const string __id = "get.(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;";
			IntPtr native_key = JNIEnv.NewString (key);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (native_key);
				var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
				return global::Java.Lang.Object.GetObject<global::Okhttp3.Internal.Cache.DiskLruCache.Snapshot> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
				JNIEnv.DeleteLocalRef (native_key);
			}
		}
