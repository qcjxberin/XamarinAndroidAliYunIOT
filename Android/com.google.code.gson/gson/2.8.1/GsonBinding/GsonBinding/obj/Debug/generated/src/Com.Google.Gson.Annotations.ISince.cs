...
namespace Com.Google.Gson.Annotations {
	...
	public partial interface ISince : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("value", "()D", "GetValueHandler:Com.Google.Gson.Annotations.ISinceInvoker, GsonBinding")]
		double Value ();

	}

	[global::Android.Runtime.Register ("com/google/gson/annotations/Since", DoNotGenerateAcw=true)]
	internal partial class ISinceInvoker : global::Java.Lang.Object, ISince {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/gson/annotations/Since", typeof (ISinceInvoker));
